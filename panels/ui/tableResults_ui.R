    ...
    column(6,
           ...
           div(style="display: inline-block", 
               dropdownButton(
                 ...
                 selectInput("ggsave_format_scorePlot", label = "Unit", choices = c("pdf", "png", "svg"),selected = "png"), 
    ...
    column(6,
           ...
           div(style="display: inline-block", 
               dropdownButton(
                 ...
                 selectInput("ggsave_format_pidPlot", label = "Unit", choices = c("pdf", "png", "svg"),selected = "png"), 
                 circle = TRUE, status = "myClass", icon = icon("gear"), width = "300px",
                 tooltip = tooltipOptions(title = "Click to see save parameters !")
               )),
